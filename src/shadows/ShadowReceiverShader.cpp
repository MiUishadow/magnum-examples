...
ShadowReceiverShader &ShadowReceiverShader::setShadowmapMatrices(Containers::ArrayView<const Matrix4> matrices) {
    setUniform(_shadowmapMatrixUniform, matrices);
    return *this;
}

ShadowReceiverShader &ShadowReceiverShader::setLightDirection(const Vector3& vector3) {
    setUniform(_lightDirectionUniform, vector3);
    return *this;
}
