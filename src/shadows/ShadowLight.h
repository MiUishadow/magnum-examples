#ifndef Magnum_Examples_ShadowLight_h
#define Magnum_Examples_ShadowLight_h
/*
...
class ShadowLight: public SceneGraph::Camera3D {
    public:
        ...
        std::vector<Vector3> getLayerFrustumCorners(SceneGraph::Camera3D& mainCamera, Int layer);
